...
export const SIDEBAR_INDICATORS = [
  ...
  { indicator: 'FP.CPI.TOTL.ZG',     label: 'Inflation',           format: 'percent', unit: '%' },
  ...
  { indicator: 'EN.GHG.CO2.PC.CE.AR5', label: 'CO₂ per Capita',    format: 'decimal', unit: 'tonnes' },
  ...
  { indicator: 'EN.GHG.CO2.MT.CE.AR5', label: 'CO₂ Emissions',   format: 'integer', unit: 'Mt CO₂e' },
]
